...
btnOn.addEventListener("mouseout", function () {
  if (anim.playDirection == -1) {
    anim.setDirection(1);
    anim.play();
    btnOn.querySelector('input[type="checkbox"]').classList.remove("on");
    btnOn.nextElementSibling.firstElementChild.classList.remove("on");
  }
});

btnOn.addEventListener("mouseover", function () {
  btnOn.querySelector('input[type="checkbox"]').classList.add("on");
  btnOn.nextElementSibling.firstElementChild.classList.add("on");
  anim.setDirection(-1);
  anim.play();
});
